...
class Kategori extends NS_Controller {
    public function __construct(){
        ...
        $this->controller_name = "nh_admin/kategori";
        $this->title = "Kategori";
        ...
        $this->data["menu_selector"] = $this->menu_model->all(" AND (id=3 OR id=4 ) ");
    ...
    public function listener(){
        ...
        $data = $datatables
            ...
            ->where(' (a.parent = 3 OR a.parent = 4)')
            ->edit_column("id", "$1", "select_helper(id)")
            ->add_column("action", "$1", "action_helper('nh_admin/kategori',id)")
            ->generate();
        echo $data;
    }
