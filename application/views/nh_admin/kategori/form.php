            ...
            <?php echo form_open_multipart($action, 'class="form-horizontal" method="post" data-parsley-validate'); ?>
                <div class="box-body">
                  ...
                  <div class="form-group ">
                    <?php echo form_label('Saction','full name',array('class'=>'control-label col-sm-2')); ?>
                    <div class="col-sm-5">
                  ...
                  <div class="form-group ">
                    <?php echo form_label('Kategori','Kategori',array('class'=>'control-label col-sm-2')); ?>
                    <div class="col-sm-5">
                  ...
                  <input type="hidden"  name="is_single_page" id="is_single_page" value="0">
                  <!--div class="form-group ">
