          ...
          <div class="box-body">
            ...
            <?php echo form_open_multipart($action, 'class="form-horizontal" method="post" data-parsley-validate'); ?>
                <div class="box-body">
                  ...
                  <div class="form-group ">
                    <?php echo form_label('Year','Year',array('class'=>'control-label col-sm-2')); ?>
                    <div class="col-sm-5">
                      <?php $form = array("name"=>"year","id"=>"year","class"=>"form-control","type"=>"text","required"=>"required","value"=>isset($db_data["year"])?$db_data["year"]:"" ) ?>
                      <?php echo form_input($form); ?>
                    </div>
                  </div>
